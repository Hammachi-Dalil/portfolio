...
function portfolio_setup() {
	...
	register_nav_menus(
		array(
			...
			'footer_menu' => esc_html__( 'Footer', 'portfolio' ),
		)
	);
...
function wpb_add_google_fonts() {
    wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto:wght@400;500&display=swap', false ); 
}
